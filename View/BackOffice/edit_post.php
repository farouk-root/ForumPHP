...
<div class="contact-container">
    ...
    <div class="contact-form">
        ...
        <form id="contact-form" name="ForumPost" method="post">
            <input type="text" name="title" id="title" placeholder="Post Title" value="<?php echo $post['TITRE']; ?>">
            <span id="titleError" class="error-message"></span><br>

            <textarea name="content" id="content" placeholder="Post Content"><?php echo $post['Content']; ?></textarea><br>
            <span id="contentError" class="error-message"></span><br>


            <input type="number" name="upVotes" id="upVotes" placeholder="Up Votes" value="<?php echo $post['Upvote']; ?>">
